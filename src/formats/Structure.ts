...
export class StructurePaletteEntry extends NBTDocument {
...
export class StructureSchematic extends NBTDocument {
    ...
    @Field("List", ["Compound", StructurePaletteEntry]) palette: StructurePaletteEntry[] = [];
    @Field("List", ["List", ["Compound", StructurePaletteEntry]]) palettes: StructurePaletteEntry[][] = [];
